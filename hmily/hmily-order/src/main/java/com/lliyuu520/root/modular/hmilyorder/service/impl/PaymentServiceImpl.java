package com.lliyuu520.root.modular.hmilyorder.service.impl;
...
import com.lliyuu520.root.modular.hmilyorder.enums.OrderStatusEnum;
import com.lliyuu520.root.modular.hmilyorder.service.OrderFormService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public void createHmilyOrder(OrderDTO orderDTO) {
        HmilyOrder hmilyOrder = buildOrder(orderDTO);
        orderFormService.createOrderForm(hmilyOrder);
    }
     ...
     * @return
     */
    protected HmilyOrder buildOrder(OrderDTO orderDTO) {
        log.info("构建订单对象");
        Long productId = orderDTO.getProductId();
        Integer productNum = orderDTO.getProductNum();
        Long userId = orderDTO.getUserId();

        HmilyOrder hmilyOrder = new HmilyOrder();
    ...
    public void pay(Long orderId) {
        ...
        HmilyOrder hmilyOrder = orderFormService.getById(orderId);
