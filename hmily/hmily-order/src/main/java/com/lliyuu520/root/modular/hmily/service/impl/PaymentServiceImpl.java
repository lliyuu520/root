...
import com.lliyuu520.root.modular.hmily.enums.OrderStatusEnum;
import com.lliyuu520.root.modular.hmily.service.HmilyOrderService;
import com.lliyuu520.root.modular.hmily.service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    private final HmilyOrderService hmilyOrderService;
    ...
    public void createHmilyOrder(OrderDTO orderDTO) {
        ...
        hmilyOrderService.createOrderForm(hmilyOrder);
    }
    ...
    public void pay(Long orderId) {
        ...
        hmilyOrderService.modifyPayStatusById(orderId, OrderStatusEnum.PAYING.getCode());
        log.info("=========修改订单状态为{}==========", OrderStatusEnum.PAYING.getDesc());
        HmilyOrder hmilyOrder = hmilyOrderService.getById(orderId);
    ...
    public void confirmOrder(Long orderId) {
        hmilyOrderService.modifyPayStatusById(orderId, OrderStatusEnum.PAY_SUCCESS.getCode());
    ...
    public void cancelOrder(Long orderId) {
        hmilyOrderService.modifyPayStatusById(orderId, OrderStatusEnum.PAY_FAIL.getCode());
